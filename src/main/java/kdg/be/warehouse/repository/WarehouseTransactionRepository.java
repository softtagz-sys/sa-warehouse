...
public interface WarehouseTransactionRepository extends JpaRepository<WarehouseTransaction, UUID> {
    ...
    List<WarehouseTransaction> findAllByRemainingAmountGreaterThanAndTransactionTimeBeforeOrderByTransactionTimeAsc(double remainingAmount, LocalDateTime transactionTime);
